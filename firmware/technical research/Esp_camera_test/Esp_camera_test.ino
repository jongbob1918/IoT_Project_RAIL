...
// const char* ssid = "SO070VOIP3511";
// const char* password = "62CE563510";

// UDP 설정
WiFiUDP udp;
// const char* udp_address = "192.168.232.32"; // PC 수신기 주소
const char* udp_address = "192.168.2.198"; // PC 수신기 주소
// const char* udp_address = "192.168.200.113"; // PC 수신기 주소
...
void setup() 
{
  ...
  IPAddress local_IP(192, 168, 2, 168); // ESP32가 사용할 IP address
  IPAddress gateway(192, 168, 2, 1);    // Gateway IP address (공유기 IP주소)
  // IPAddress local_IP(192, 168, 200, 168); // ESP32가 사용할 IP address
  // IPAddress gateway(192, 168, 200, 1);    // Gateway IP address (공유기 IP주소)
