...
class DatabaseMigration:
    ...
    def _insert_initial_data(self) -> bool:
        ...
        try:
            ...
            # product_item 테스트 데이터 삽입
            product_item_sql = """
                INSERT INTO `product_item` VALUES 
                ('01','A','01','2026-06-01','2025-05-05 14:30:00'),
                ('02','A','02','2026-09-15','2025-05-05 14:35:00'),
                ('03','A','02','2026-09-15','2025-05-05 14:40:00'),
                ('04','A','03','2026-07-31','2025-05-05 14:45:00'),
                ('05','B','04','2025-07-01','2025-05-05 14:50:00'),
                ('06','B','05','2025-05-21','2025-05-05 14:55:00'),
                ('07','B','05','2025-05-10','2025-05-05 15:00:00'),
                ('08','B','06','2025-05-10','2025-05-05 15:05:00'),
                ('09','B','07','2025-05-22','2025-05-05 15:10:00'),
                ('10','B','08','2025-05-08','2025-05-05 15:15:00'),
                ('11','B','08','2025-05-09','2025-05-05 15:20:00'),
                ('12','B','09','2025-05-07','2025-05-05 15:25:00'),
                ('13','C','10','2025-12-31','2025-05-05 15:30:00'),
                ('14','C','10','2025-12-31','2025-05-05 15:35:00'),
                ('15','C','11','2026-06-01','2025-05-05 15:40:00'),
                ('16','C','12','2026-06-01','2025-05-05 15:45:00'),
                ('17','C','13','2026-09-01','2025-05-05 15:50:00'),
                ('18','C','14','2026-09-01','2025-05-05 15:55:00'),
                ('19','C','15','2026-08-01','2025-05-05 16:00:00'),
                ('20','C','15','2026-08-01','2025-05-05 16:05:00'),
                ('21','A','01','2026-09-01','2025-05-06 14:05:00'),
                ('22','A','01','2026-09-01','2025-05-06 14:10:00'),
                ('23','A','02','2026-09-01','2025-05-06 14:15:00'),
                ('24','A','02','2026-09-01','2025-05-06 14:20:00'),
                ('25','A','03','2026-09-01','2025-05-06 14:25:00'),
                ('26','B','04','2025-07-01','2025-05-06 14:30:00'),
                ('27','B','05','2025-06-10','2025-05-06 14:35:00'),
                ('28','B','06','2025-06-15','2025-05-06 14:40:00'),
                ('29','B','07','2025-06-03','2025-05-06 14:45:00'),
                ('30','B','07','2025-06-03','2025-05-06 14:50:00'),
                ('31','B','08','2025-05-09','2025-05-07 14:05:00'),
                ('32','B','08','2025-05-10','2025-05-07 14:10:00'),
                ('33','B','09','2025-05-08','2025-05-07 14:15:00'),
                ('34','C','10','2026-12-31','2025-05-07 14:20:00'),
                ('35','C','11','2026-06-01','2025-05-07 14:25:00'),
                ('36','C','12','2026-06-01','2025-05-07 14:30:00'),
                ('37','C','12','2026-06-01','2025-05-07 14:35:00'),
                ('38','C','13','2026-09-01','2025-05-07 14:40:00'),
                ('39','C','14','2026-09-01','2025-05-07 14:45:00'),
                ('40','C','15','2026-08-01','2025-05-07 14:50:00');
            """
            self.db.execute_update(product_item_sql)
            logger.info("product_item 테스트 데이터 삽입 완료")
